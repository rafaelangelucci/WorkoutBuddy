...
public class NewExerciseTest extends ActivityInstrumentationTestCase2<NewExerciseActivity> implements HttpRequestListener {
	...
	protected void setUp() throws Exception {
        ...
        mTextName = (EditText) mActivity.findViewById(com.uiuc.workoutbuddy.R.id.edit_exercise_name);
        mTextDesc = (EditText) mActivity.findViewById(com.uiuc.workoutbuddy.R.id.edit_exercise_description);
        mSpinType = (Spinner) mActivity.findViewById(com.uiuc.workoutbuddy.R.id.spinner_exercise_type);
        mButton = (Button) mActivity.findViewById(com.uiuc.workoutbuddy.R.id.btn_new_exercise_ok);
	}
	...
	/**
	 * Test that an exercise is actually created with the entered information when everything is done correctly.
	 * @throws Throwable
	 */
