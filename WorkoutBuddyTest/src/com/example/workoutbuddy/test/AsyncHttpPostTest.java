...
public class AsyncHttpPostTest extends TestCase implements HttpRequestListener {
	 ...
	 * of Wrapper to test AsyncHttpPost
	 */
	 ...
	 */
	@UiThreadTest
	public void testMakeEmptyRequest() throws InterruptedException,
			ExecutionException {
		String URL = "http://workoutbuddy.web.engr.illinois.edu/PhpFiles/emptyPostRequestTest.php";
		String response = wrapper.makeRequest(new HashMap<String, Object>(),
				URL);
	...
	@UiThreadTest
	public void testAddGetModifyGetDeleteWorkout() throws InterruptedException,
			ExecutionException {
		Workout workout = new Workout("TestWorkout", "03/20/2014", "testdesc",
				"usernameA", null);
	...
	@UiThreadTest
	public void testAddGetModifyGetDeleteExercise()
			throws InterruptedException, ExecutionException {
		Exercise exercise = new Exercise("TestExercise", "strength",
				"testdesc", "usernameA", null);
