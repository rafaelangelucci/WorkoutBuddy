...
Class ParameterizedWorkoutTest extends PHPUnit_Framework_TestCase {
	/**
	 * Function that outputs testing data
	 */
	public static function workoutData() {
		$data1 = array( array('name' => 'Heavy Upper', 'date' => '04/14/2014', 'description' => 'Heavy day of lifts for the upper body', 'username' => 'test'));
		$data2 = array( array('name' => 'Light Upper', 'date' => '05/30/2013', 'description' => 'Light day of lifts for the upper body', 'username' => 'test'));
		$data3 = array( array('name' => 'Heavy Lower', 'date' => '06/14/1992', 'description' => 'Heavy day of lifts for the lower body', 'username' => 'test'));
		$data4 = array( array('name' => 'Light Lower', 'date' => '01/14/2014', 'description' => 'Light day of lifts for the lower body', 'username' => 'test'));
	 ...
	 * Makes a call to each of the database operations and checks that everything is 
	 * done correctly
	 */
