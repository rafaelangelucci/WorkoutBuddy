...
Class ParameterizedTest extends PHPUnit_Framework_TestCase {
	...
	public static function exerciseData() {
		$data1 = array( array('type' => 'strength', 'name' => 'pushups', 'description' => 'get on floor', 'username' => 'test'));
		$data2 = array( array('type' => 'distance', 'name' => 'run', 'description' => 'run...', 'username' => 'user'));
		$data3 = array( array('type' => 'speed', 'name' => 'sprint', 'description' => 'run really fast', 'username' => 'username'));
		$data4 = array( array('type' => 'strength', 'name' => 'squat', 'description' => 'sitting motion', 'username' => 'new'));
		return array($data1, $data2, $data3, $data4);
	}

	/**
	 * @dataProvider exerciseData
	 * Goes through and tests all the database functions for Exercises
	 */
	public function testAddGetDeleteExercise($data) {
